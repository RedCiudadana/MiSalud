...
export default Route.extend({
  ...
  setupController(controller, model) {
    ...
    controller.montoTotal = model.comprasresumen.findBy('variable', 'montoTotal');

    controller.concursos = model.comprasresumen.findBy('variable', 'concursos');

    controller.concursosTerminados = model.comprasresumen.findBy('variable', 'concursosTerminados');

    controller.concursosVigente = model.comprasresumen.findBy('variable', 'concursosVigente');

    let applicationController = this.controllerFor('application');
    applicationController.set('isEmbed', true);
  },

  actions: {
    willTransition() {
      let applicationController = this.controllerFor('application');
      applicationController.set('isEmbed', false);
    }
  }
});
